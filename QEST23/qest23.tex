...
\begin{figure}
  ...
  \end{minipage}
  \caption{Learning outcomes of the bounding ball (left) and the DC-DC boost converter (right) TODO: Full data.}
  \label{fig:casestudies}
\end{figure}

Figure~\ref{fig:casestudies} shows the expected reward of an agent trained in an IMDP of varying granularity $i$.
